...
$scanExpected = json_encode($scan, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES);
if (!is_file(app_path('docs/systematic-map.json')) || trim(file_get_contents(app_path('docs/systematic-map.json'))) !== trim($scanExpected)) { fwrite(STDERR, "Generated systematic map is stale\n"); exit(1); }
