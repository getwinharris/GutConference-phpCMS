...
final class AdminController extends BaseController {
    ...
    public function saveSettings(): void{(new SettingsService())->savePublic(['currency'=>$_POST['currency'] ?? 'INR','timezone'=>$_POST['timezone'] ?? 'Asia/Kolkata','featured_event_slug'=>$_POST['featured_event_slug'] ?? 'global-gut-summit-2026','product_owner_name'=>$_POST['product_owner_name'] ?? 'Dr. Praveen Jacob','product_owner_title'=>$_POST['product_owner_title'] ?? 'The Gut Expert','product_owner_handle'=>$_POST['product_owner_handle'] ?? '@the.gut.expert','product_owner_instagram'=>$_POST['product_owner_instagram'] ?? 'https://www.instagram.com/the.gut.expert']); $this->flash('Settings saved.'); $this->redirect('/admin/settings');}
