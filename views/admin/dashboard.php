<div class="admin-card">
    ...
    <div class="admin-form__row">
        <div class="admin-card"><strong style="font-size:30px"><?= (int)($eventCount ?? 0) ?></strong><br><span>Events &amp; Classes</span></div>
...
<div class="admin-card">
    ...
    <div style="display:flex;gap:10px;flex-wrap:wrap">
        <a class="btn btn-primary" href="/admin/events">Edit Events &amp; Classes</a>
