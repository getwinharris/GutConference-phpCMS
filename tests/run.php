...
assertTrue(str_contains(file_get_contents(app_path('app/Controllers/AuthController.php')) ?: '', "\$_GET['error']") && str_contains(file_get_contents(app_path('app/Controllers/AuthController.php')) ?: '', 'OAuth app is still in testing'), 'Google OAuth callback explains access_denied testing/verification errors');
...
assertTrue(trim(file_get_contents(app_path('googledd40556ecdb2f85a.html')) ?: '') === 'google-site-verification: googledd40556ecdb2f85a.html', 'Google Search Console HTML verification file is present at site root');
...
assertTrue(str_contains($integrations, 'Fix Google 403 access_denied') && str_contains($integrations, 'OAuth consent screen -> Test users') && str_contains($integrations, 'calendar.events'), 'integrations explain Google OAuth testing, redirect, and verification requirements');
